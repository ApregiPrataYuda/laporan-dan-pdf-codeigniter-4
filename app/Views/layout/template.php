...
<head>
  ...
  <link href='<?= base_url() ?>Assets/backend/vendors/jquery-ui/jquery-ui.theme.css' rel='stylesheet'>

  <!-- assets untuk date-picker -->
  ...
  <div class="wrapper">
    ...
    <aside style="background-color:RGB(40, 178, 170);" class="main-sidebar sidebar-light elevation-4">
      ...
      <a href="" class="brand-link">
        ...
        <span style="color: RGB(245, 245, 245); font-style: bold;" class="brand-text font-weight-dark">Report CI4</span>
      </a>
...
<script>
  ...
  <script>
    ...
    var errValidation = $('#errValidation').data('errValidation');
    if (errValidation) {
      Swal.fire({
        icon: 'info',
        title: 'Gagal',
